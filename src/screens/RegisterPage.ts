import { registerAndVerify, RegisterPayload } from "../helpers/api-client";
...
export class RegisterPage extends BasePage {
  ...
  async registerAndVerifyNewUser(data:RegisterPayload){
    return await registerAndVerify(data);
  }
}
